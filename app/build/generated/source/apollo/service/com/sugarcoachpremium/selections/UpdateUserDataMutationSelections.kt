...
public object UpdateUserDataMutationSelections {
  ...
  private val __updateUserData: List<CompiledSelection> = listOf(
        CompiledField.Builder(
          name = "data",
  ...
  public val __root: List<CompiledSelection> = listOf(
        CompiledField.Builder(
          ...
          CompiledArgument.Builder("data", CompiledVariable("user")).build(),
          CompiledArgument.Builder("id", CompiledVariable("id")).build()
        ))
        .selections(__updateUserData)
        .build()
      )
}
