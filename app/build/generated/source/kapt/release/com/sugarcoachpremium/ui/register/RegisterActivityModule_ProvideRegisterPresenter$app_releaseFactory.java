...
public final class RegisterActivityModule_ProvideRegisterPresenter$app_releaseFactory implements Factory<RegisterPresenterImp<RegisterView, RegisterInteractorImp>> {
  ...
  public RegisterActivityModule_ProvideRegisterPresenter$app_releaseFactory(
  ...
  public RegisterPresenterImp<RegisterView, RegisterInteractorImp> get() {
    return provideRegisterPresenter$app_release(module, registerPresenterProvider.get());
  }

  public static RegisterActivityModule_ProvideRegisterPresenter$app_releaseFactory create(
      RegisterActivityModule module,
      Provider<RegisterPresenter<RegisterView, RegisterInteractorImp>> registerPresenterProvider) {
    return new RegisterActivityModule_ProvideRegisterPresenter$app_releaseFactory(module, registerPresenterProvider);
  }

  public static RegisterPresenterImp<RegisterView, RegisterInteractorImp> provideRegisterPresenter$app_release(
      RegisterActivityModule instance,
      RegisterPresenter<RegisterView, RegisterInteractorImp> registerPresenter) {
    return Preconditions.checkNotNullFromProvides(instance.provideRegisterPresenter$app_release(registerPresenter));
  }
}
