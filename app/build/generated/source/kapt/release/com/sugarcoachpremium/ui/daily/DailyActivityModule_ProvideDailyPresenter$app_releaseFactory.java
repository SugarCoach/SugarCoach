...
public final class DailyActivityModule_ProvideDailyPresenter$app_releaseFactory implements Factory<DailyPresenterImp<DailyView, DailyInteractorImp>> {
  ...
  public DailyActivityModule_ProvideDailyPresenter$app_releaseFactory(DailyActivityModule module,
  ...
  public DailyPresenterImp<DailyView, DailyInteractorImp> get() {
    return provideDailyPresenter$app_release(module, dailyPresenterProvider.get());
  }

  public static DailyActivityModule_ProvideDailyPresenter$app_releaseFactory create(
      DailyActivityModule module,
      Provider<DailyPresenter<DailyView, DailyInteractorImp>> dailyPresenterProvider) {
    return new DailyActivityModule_ProvideDailyPresenter$app_releaseFactory(module, dailyPresenterProvider);
  }

  public static DailyPresenterImp<DailyView, DailyInteractorImp> provideDailyPresenter$app_release(
      DailyActivityModule instance, DailyPresenter<DailyView, DailyInteractorImp> dailyPresenter) {
    return Preconditions.checkNotNullFromProvides(instance.provideDailyPresenter$app_release(dailyPresenter));
  }
}
