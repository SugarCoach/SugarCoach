...
public final class DailyDetailActivityModule_ProvideDailyDetailPresenter$app_releaseFactory implements Factory<DailyDetailPresenterImp<DailyDetailView, DailyDetailInteractorImp>> {
  ...
  public DailyDetailActivityModule_ProvideDailyDetailPresenter$app_releaseFactory(
  ...
  public DailyDetailPresenterImp<DailyDetailView, DailyDetailInteractorImp> get() {
    return provideDailyDetailPresenter$app_release(module, dailyDetailPresenterProvider.get());
  }

  public static DailyDetailActivityModule_ProvideDailyDetailPresenter$app_releaseFactory create(
      DailyDetailActivityModule module,
      Provider<DailyDetailPresenter<DailyDetailView, DailyDetailInteractorImp>> dailyDetailPresenterProvider) {
    return new DailyDetailActivityModule_ProvideDailyDetailPresenter$app_releaseFactory(module, dailyDetailPresenterProvider);
  }

  public static DailyDetailPresenterImp<DailyDetailView, DailyDetailInteractorImp> provideDailyDetailPresenter$app_release(
      DailyDetailActivityModule instance,
      DailyDetailPresenter<DailyDetailView, DailyDetailInteractorImp> dailyDetailPresenter) {
    return Preconditions.checkNotNullFromProvides(instance.provideDailyDetailPresenter$app_release(dailyDetailPresenter));
  }
}
