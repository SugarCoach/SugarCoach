...
public final class ConfigActivityModule_ProvideConfigPresenter$app_releaseFactory implements Factory<ConfigPresenterImp<ConfigView, ConfigInteractorImp>> {
  ...
  public ConfigActivityModule_ProvideConfigPresenter$app_releaseFactory(ConfigActivityModule module,
  ...
  public ConfigPresenterImp<ConfigView, ConfigInteractorImp> get() {
    return provideConfigPresenter$app_release(module, configPresenterProvider.get());
  }

  public static ConfigActivityModule_ProvideConfigPresenter$app_releaseFactory create(
      ConfigActivityModule module,
      Provider<ConfigPresenter<ConfigView, ConfigInteractorImp>> configPresenterProvider) {
    return new ConfigActivityModule_ProvideConfigPresenter$app_releaseFactory(module, configPresenterProvider);
  }

  public static ConfigPresenterImp<ConfigView, ConfigInteractorImp> provideConfigPresenter$app_release(
      ConfigActivityModule instance,
      ConfigPresenter<ConfigView, ConfigInteractorImp> configPresenter) {
    return Preconditions.checkNotNullFromProvides(instance.provideConfigPresenter$app_release(configPresenter));
  }
}
