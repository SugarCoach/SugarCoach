...
public final class OnBoardingActivityModule_ProvideOnBoardingPresenter$app_releaseFactory implements Factory<OnBoardingPresenterImp<OnBoardingView, OnBoardingInteractorImp>> {
  ...
  public OnBoardingActivityModule_ProvideOnBoardingPresenter$app_releaseFactory(
  ...
  public OnBoardingPresenterImp<OnBoardingView, OnBoardingInteractorImp> get() {
    return provideOnBoardingPresenter$app_release(module, onboardingPresenterProvider.get());
  }

  public static OnBoardingActivityModule_ProvideOnBoardingPresenter$app_releaseFactory create(
      OnBoardingActivityModule module,
      Provider<OnBoardingPresenter<OnBoardingView, OnBoardingInteractorImp>> onboardingPresenterProvider) {
    return new OnBoardingActivityModule_ProvideOnBoardingPresenter$app_releaseFactory(module, onboardingPresenterProvider);
  }

  public static OnBoardingPresenterImp<OnBoardingView, OnBoardingInteractorImp> provideOnBoardingPresenter$app_release(
      OnBoardingActivityModule instance,
      OnBoardingPresenter<OnBoardingView, OnBoardingInteractorImp> onboardingPresenter) {
    return Preconditions.checkNotNullFromProvides(instance.provideOnBoardingPresenter$app_release(onboardingPresenter));
  }
}
