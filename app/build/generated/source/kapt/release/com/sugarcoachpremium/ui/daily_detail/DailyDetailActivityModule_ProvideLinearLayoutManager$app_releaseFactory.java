...
public final class DailyDetailActivityModule_ProvideLinearLayoutManager$app_releaseFactory implements Factory<LinearLayoutManager> {
  private final DailyDetailActivityModule module;

  private final Provider<DailyDetailActivity> contextProvider;

  public DailyDetailActivityModule_ProvideLinearLayoutManager$app_releaseFactory(
  ...
  public static DailyDetailActivityModule_ProvideLinearLayoutManager$app_releaseFactory create(
      DailyDetailActivityModule module, Provider<DailyDetailActivity> contextProvider) {
    return new DailyDetailActivityModule_ProvideLinearLayoutManager$app_releaseFactory(module, contextProvider);
  }
