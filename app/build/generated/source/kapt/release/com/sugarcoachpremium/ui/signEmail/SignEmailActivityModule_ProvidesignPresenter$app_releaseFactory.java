...
public final class SignEmailActivityModule_ProvidesignPresenter$app_releaseFactory implements Factory<SignEmailPresenterImp<SignEmailView, SignEmailInteractorImp>> {
  ...
  public SignEmailActivityModule_ProvidesignPresenter$app_releaseFactory(
  ...
  public SignEmailPresenterImp<SignEmailView, SignEmailInteractorImp> get() {
    return providesignPresenter$app_release(module, signEmailPresenterProvider.get());
  }

  public static SignEmailActivityModule_ProvidesignPresenter$app_releaseFactory create(
      SignEmailActivityModule module,
      Provider<SignEmailPresenter<SignEmailView, SignEmailInteractorImp>> signEmailPresenterProvider) {
    return new SignEmailActivityModule_ProvidesignPresenter$app_releaseFactory(module, signEmailPresenterProvider);
  }

  public static SignEmailPresenterImp<SignEmailView, SignEmailInteractorImp> providesignPresenter$app_release(
      SignEmailActivityModule instance,
      SignEmailPresenter<SignEmailView, SignEmailInteractorImp> signEmailPresenter) {
    return Preconditions.checkNotNullFromProvides(instance.providesignPresenter$app_release(signEmailPresenter));
  }
}
