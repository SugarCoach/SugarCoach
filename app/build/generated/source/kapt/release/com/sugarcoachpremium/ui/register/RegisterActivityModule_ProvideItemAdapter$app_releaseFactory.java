...
public final class RegisterActivityModule_ProvideItemAdapter$app_releaseFactory implements Factory<ItemAdapter> {
  private final RegisterActivityModule module;

  private final Provider<RegisterActivity> contextProvider;

  public RegisterActivityModule_ProvideItemAdapter$app_releaseFactory(RegisterActivityModule module,
  ...
  public static RegisterActivityModule_ProvideItemAdapter$app_releaseFactory create(
      RegisterActivityModule module, Provider<RegisterActivity> contextProvider) {
    return new RegisterActivityModule_ProvideItemAdapter$app_releaseFactory(module, contextProvider);
  }

  public static ItemAdapter provideItemAdapter$app_release(RegisterActivityModule instance,
