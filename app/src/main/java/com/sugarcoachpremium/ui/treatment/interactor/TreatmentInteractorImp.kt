...
interface TreatmentInteractorImp : Interactor {
    ...
    suspend fun editTreatment(treament: Treament, basalInsuline: String, correctoraInsuline: String, medidorName: String, bombaInfusoraName: String): Observable<Boolean>
